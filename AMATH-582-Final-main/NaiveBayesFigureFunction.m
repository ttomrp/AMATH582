function NaiveBayesFigureFunction(data, titleName)
    ...
    model = fitcnb(data, 'P_CREDDESC~P_DEBTMEAN+P_MD_EARN_WNE');
    ...
    gscatter(data.P_DEBTMEAN, data.P_MD_EARN_WNE, data.P_CREDDESC, color(1:6,:), '.', 20);
end